    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-md-offset-3 panel panel-default">
          ...
          <form class="form-horizontal" action="<?php echo base_url();?>carrera/EditarCarrera" method="Post">
            ...
            <fie1ldset>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="nombre" name="nombre" type="text" placeholder="Nombre de la Carrera"
