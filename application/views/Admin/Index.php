...
<![endif]-->
  ...
  <body>
    ...
    <div class="container">
      <H1 id="t" class="margin-base-vertical">ADMINISTRATIVOS DE LA UNIVERSIDAD TECNICA NACIONAL</H1>
      <?php
        foreach ($data as $row) {            
            ...
            echo '                    <li><a href="' . base_url() . 'admin/Editar/' . $row['Id'] . '"><span class="icon-wrench"></span> Editar</a></li>';
            echo '                    <li><a href="' . base_url() . 'admin/Eliminar/' . $row['Id'] . '"><span class="icon-trash"></span> Eliminar</a></li>';
            echo '                </ul>';
            echo '            </div>';
