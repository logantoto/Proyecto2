...
<![endif]-->
  ...
  <body>
    ...
    <div class="container">
      <H1 id="t" class="margin-base-vertical">AULAS DE LA UNIVERSIDAD TECNICA NACIONAL</H1>
       <div  class="col-xs-15 col-sm-15 col-md-15">
          <a href="http://localhost/UTN/index.php/Aula/crear"class="btn btn-lg btn-primary btn-block">REGISTRAR AULA</a>
        </div>
      <?php
        foreach ($data as $row) {            
            ...
            echo '                    <li><a href="' . base_url() . 'aula/Editar/' . $row['Id'] . '"><span class="icon-wrench"></span> Editar</a></li>';
            echo '                    <li><a href="' . base_url() . 'aula/Eliminar/' . $row['Id'] . '"><span class="icon-trash"></span> Eliminar</a></li>';
            echo '                </ul>';
            echo '            </div>';
            echo '            <div class="media-body"> ';
            echo '                <h4 class="margin-base-vertical">'."Numero de Aula: " . $row['Numero_Aula'] . ' <small> ' . '</small></h4> '. '</span> ';
            echo '                <h4 class="margin-base-vertical">'."Nombre del Aula: ". $row['Nombre'] .'</h4> ';
            echo '                <h4 class="margin-base-vertical">'."Ubicacion del Aula: " . $row['Ubicacion'] . '</h4> ';
            echo '            </div>';
            echo '          </div>';
            echo '        </div>';
            echo '        <!-- //main content -->';
