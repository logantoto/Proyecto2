    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-md-offset-3 panel panel-default">
          ...
          <form class="form-horizontal" action="<?php echo base_url();?>aula/CrearAula" method="Post">
            <fie1ldset>
              <!-- Address form -->
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="numero_aula" name="numero_aula" type="text" placeholder="numero_aula" class="input-xlarge">
                  <p class="help-block"> 
                  </p>
                </div>
              </div>
